...
public class SumaiRóżnicaMacierzy extends Macierz {
    ...
    public static void main(String[] args) { //kod testowy
        Macierz macierz1 = new Macierz(new double[]{1.0,10.0,100.0}, new double[]{2.02,20.02,200.02});
        Macierz macierz2 = new Macierz(new double[]{3.0,30.0,300.0}, new double[]{4.0,40.0,400.0});
