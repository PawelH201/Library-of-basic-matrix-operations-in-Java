        ...
        while (true)
        {
            ...
            try
            {
                ...
                if (indeks == 1)
                {
                    ...
                    {
                        System.out.println("Dane wejściowe zostały podane w złym formacie, sprawdź czy poprawnie są wpisane!");
                        System.out.println("Wciśnij enter, aby kontynuować...");
                        try
                        {
                            System.in.read();
                ...
                {
                    System.out.println("Wybrano operację iloczynu wektorowego wektorów dla trzech wymiarów.");
                    Wektor wektor1;
                    Wektor wektor2;
            ...
            {
                System.out.println("Podaj liczbę całkowitę odpowiadającemu indeksowi!");
                try
                {
                    System.in.read();
                }
